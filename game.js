...
/** 기본 maxHp + 시너지 체력 — 회복·표시 상한에 사용 (버서커 등 %판정은 player.maxHp 유지) */
...
/** 인벤 장비 1개분을 플레이어 전투 스탯에 가산(상점 구매와 동일 규칙, merc 제외) */
...
/**
 * 메타(테크·레벨·환생)·전직 여부·인벤 장비를 기준으로 전투 스탯을 처음부터 재계산.
 * 전직 시 일부 스탯만 더하던 버그 수정 및 저장 복구 시 일관성 유지용.
 */
